...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <center>
            <h3 class="m-0 font-weight-bold text-primary">Transferir Produto</h3>
            <center>
    </div>
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><input type="checkBox" class="form-control" name="requi[]" id="<?php echo $cont; ?>" value="<?php echo $rows_consultaProduto['idProduto']; ?>"></td>
                            </tr>
                        <?php
                            $cont += 1;
                        }
