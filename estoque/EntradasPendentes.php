...
$result_consultaFiscal = "SELECT N.idNotaFiscal,N.numeroNota,N.quantidade,N.comprovanteFiscal,P.descricaoProduto, P.idProduto, L.nomeLocal, P.idLocal FROM notafiscal N 
...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
    <center>
      <h3 class="m-0 font-weight-bold text-primary">Entradas Pendentes</h3>
      <center>
  </div>
  <div class="card-body">
        ...
        <table class="table table-bordered" id="" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            while ($rows_consultaFiscal = mysqli_fetch_assoc($resultado_consultaFiscal)) {
              ...
              $select_localusu = mysqli_query($con, "SELECT * FROM local_usuario where idUsuario = '$_SESSION[idUsuario]' and idLocal = '$rows_consultaFiscal[idLocal]'");
